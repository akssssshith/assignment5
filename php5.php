...
<nav style="background-color:blue;">
 ...
 <form method="POST">
        <table border="1" cellpadding="20px" align="center">
            ...
            <tr>
                <td colspan="2" align="center"><input id="txt" type="submit" value="SUBMIT" name="submit"></td>
            </tr>
        </table>
</form>
<?php
...

{
    if($balance<500){
        ...
        mysqli_query($mysql, "INSERT INTO bank(acno,acname,a_address,accounttype,balance) VALUES('$accno','$name','$address','$acc_type','$balance')");
