...
$pname=$_FILES['file']['name'];
        ...
        mysqli_query($mysql,"INSERT INTO passport(pno,firstname,middlename,lastname,dob,nationality,addresss,gender,imagees) VALUES('$passno','$fname','$mname','$lname','$dob','$nation','$addr','$gender','$fstore')");
                    {
