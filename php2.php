...
<body>
    <form method="POST">
        <table border="1" cellpadding="20px" align="center">
            <tr>
                <th colspan="2" style="background-color:black;color:white;"> FLIGHT PREFERENCE</th>
            </tr>
            <tr>
                <th>Name</th>
...
echo "<br>";
echo 'Press <a href="viewcookie.php" style="text-decoration:none;margin:10px;display:inline-block;border:1px solid black;">GO</a> to view your cookies';
