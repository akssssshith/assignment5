...
<body style="background-color: black;color: yellow;">
    ...
    <table border="1" style="text-align:left;">
        ...
        <tr>
            <th>Enter Passport Number</th><th><input type="text" name="passno" value="<?php echo $row['pno']; ?>"></th>
        </tr>
        <tr>
...
$sql = mysqli_query($con,"UPDATE `passport` set `pno`='$passno',`fname`='$fname',`mname`='$mname',`lname`='$lname',`dob`='$dob',`nation`='$nation',`address`='$addr',`gender`='$gender',`pic`='$fstore' WHERE pno='$pno'");
if($sql)
                    {
